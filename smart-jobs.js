...
const companyCandidates = [
  {
    id: "candidate-1",
    name: "جمال الليثي",
    track: "Website designer - Developer",
    trackKey: "data",
    university: "WE For Applaied Technology",
    match: 97,
    level: "Level 3 Analyzer",
    skills: ["HTML","CSS","JS", "React" , "Power BI"],
    dna: { analytical: 82, creative: 94, social: 88 },
    projects: ["Customer Insights Dashboard", "Retail SQL Analyzer"],
    email: "gamal@email.com",
    profile: "talent-dna.html"
  },
  {
    id: "candidate-2",
    name: "سيف عبدالله",
    ...
    dna: { analytical: 22, creative: 10, social: 12 },
    projects: ["Hiring Funnel Story", "Mobile App Redesign"],
    email: "Saif Abdullah@email.com",
    profile: "talent-dna.html"
  },
  {
    id: "candidate-3",
    name: "عبدالرحمن القسط",
    ...
    email: "Abdulrahman Al-Qast@email.com",
    profile: "talent-dna.html"
  },
  {
    id: "candidate-4",
    ...
    dna: { analytical: 60, creative: 52, social: 49 },
    projects: ["Task Manager", "API Dashboard"],
    email: "Mohammed Abu Zeina@email.com",
    profile: "talent-dna.html"
  },
  {
    id: "candidate-5",
    ...
    skills: ["C#",'C+', "APIs", "React"],
    dna: { analytical: 60, creative: 52, social: 49 },
    projects: ["Task Manager", "API Dashboard"],
    email: "Adam Salam@email.com",
    profile: "talent-dna.html"
  },
  {
    id: "candidate-6",
  ...
  },
 {
    ...
    match: 81,
    level: "Level 2 Builder",
    skills: ["SQL",'C++',"OOP", "APIs"],
    dna: { analytical: 60, creative: 52, social: 49 },
    projects: ["Task Manager", "API Dashboard"],
    email: "Subliman Zian@email.com",
    profile: "talent-dna.html"
  },
  {
    id: "candidate-8",
  ...
  },
  {
    ...
    match: 89,
    level: "Level 3 Builder",
    skills: ["SQL",'C++', "APIs","Python","JS","C+","C#"],
    dna: { analytical: 80, creative: 22, social: 49 },
    projects: ["Task Manager", "API Dashboard"],
    email: "Amr Abbas@email.com",
    profile: "talent-dna.html"
  },
  {
    id: "candidate-10",
    ...
    match: 63,
    level: "Level 2 Builder",
    skills: ["UX", "Figma", "Research", "React"],
    dna: { analytical: 60, creative: 52, social: 49 },
    projects: ["Task Manager", "API Dashboard"],
    email: "Mohamed Yasser@email.com",
    profile: "talent-dna.html"
  },
  {
    id: "candidate-11",
    name: "عبدالرحمن هاني",
    track: "IT Engineering",
    trackKey: "IT",
    university: "WE For Applaied Technology",
    match: 29,
    level: "Level 1 Builder",
    skills: ["Algorithms", "fiber optic cables"],
    dna: { analytical: 60, creative: 52, social: 49 },
    projects: ["Task Manager", "API Dashboard"],
    email: "Abdulrahman Hani@email.com",
    profile: "talent-dna.html"
  },
  {
    id: "candidate-12",
    ...
    dna: { analytical: 60, creative: 52, social: 49 },
    projects: ["Task Manager", "API Dashboard"],
    email: "Omar Nasr@email.com",
    profile: "talent-dna.html"
  },{
    id: "candidate-13",
    name: "عبدالرحمن الخياط",
    track: "IT Engineering ",
    trackKey: "IT",
    university: "WE For Applaied Technology",
    match: 20,
    ...
    dna: { analytical: 60, creative: 52, social: 49 },
    projects: ["Task Manager", "API Dashboard"],
    email: "Abdulrahman Al-Khayyat@email.com",
    profile: "talent-dna.html"
  }
...
function bindStudentActions() {
  document.querySelectorAll("[data-open-job]").forEach((button) => {
    button.addEventListener("click", () => openJobDetails(button.getAttribute("data-open-job")));
  });
